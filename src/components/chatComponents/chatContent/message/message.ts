...
const message =`<div class="chat-content__messages__message message {{userClass}}">
...
class Message extends Block<IMessageProps>{
    constructor(props:IMessageProps){
        ...
        props.class = props.isMyMessage ? "chat-content__messages__message-container_right" : 
